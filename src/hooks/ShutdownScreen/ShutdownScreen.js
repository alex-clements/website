...
export default function ShutdownScreen(props) {
  ...
  const textBlock2 = () => {
    ...
    init(myElement2, {
      ...
      cursorChar: "_",
      typeSpeed: 10,
      strings: ["to see more of my projects, check out my"],
      startDelay: 100,
      onFinished: textBlock3,
    });
  };
  ...
  return (
    <div className="shutdown-screen">
      ...
      <strong>
        <a
          className="shutdown-screen-text"
          href="https://github.com/alex-clements"
        >
          <p className="shutdown-screen-text" id="shutdownElement3"></p>
        </a>
      </strong>
    </div>
  );
